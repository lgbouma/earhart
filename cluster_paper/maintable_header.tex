...
\startdata
  ...
  \texttt{radial\_velocity\_error} &            1.945767 &                                          Gaia DR2 radial velocity uncertainty. \\
           ...
           \texttt{is\_astrm\_bin} &                True &                                                  True if Gaia EDR3 RUWE > 1.2. \\
                     \texttt{ruwe} &            2.221799 &                                                                Gaia EDR3 RUWE. \\
      \texttt{Li\_EW\_mA\_GaiaESO} &                 NaN &                                    Gaia-ESO Li doublet equivalent width [m\AA] \\
\texttt{Li\_EW\_mA\_perr\_GaiaESO} &                 NaN & Gaia-ESO Li doublet EW 84$^{\mathrm{th}}$-50$^{\mathrm{th}}$ percentile [m\AA] \\
\texttt{Li\_EW\_mA\_merr\_GaiaESO} &                 NaN & Gaia-ESO Li doublet EW 50$^{\mathrm{th}}$-16$^{\mathrm{th}}$ percentile [m\AA] \\
        \texttt{Li\_EW\_mA\_GALAH} &                 NaN &                                       GALAH Li doublet equivalent width [m\AA] \\
  \texttt{Li\_EW\_mA\_perr\_GALAH} &                 NaN &    GALAH Li doublet EW 84$^{\mathrm{th}}$-50$^{\mathrm{th}}$ percentile [m\AA] \\
  \texttt{Li\_EW\_mA\_merr\_GALAH} &                 NaN &    GALAH Li doublet EW 50$^{\mathrm{th}}$-16$^{\mathrm{th}}$ percentile [m\AA] \\
\enddata
