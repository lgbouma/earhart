...
more massive clusters make it maybe 100 Myr. Maybe a bit longer.
...
itself, and how many high-mass (O and B) stars form, since their winds
...
in the Southern Ecliptic hemisphere, available on MAST\footnote{\url{https://archive.stsci.edu/hlsp/cdips}}.
...
of young stars for a transit search, we focus in his
paper on a rather modest question: in just a single rich
...
($\sim$112\,Myr) and close ($d=400$\,pc) enough to facilitate rotation
...
Section~\ref{sec:agedate} age-dates the halo of NGC\,2516,
based on Gaia photometry (Section~\ref{subsec:hr}),
TESS gyrochronology (Section~\ref{subsec:tess}), and lithium depletion
