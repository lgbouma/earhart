...
\begin{figure*}[t]
	\begin{center}
		\leavevmode
		\subfloat{
			\includegraphics[width=0.7\textwidth]{f3a.pdf}
		}

    \vspace{-0.5cm}
		\subfloat{
			\includegraphics[width=0.7\textwidth]{f3b.pdf}
		}
	\end{center}
	\vspace{-0.7cm}
...
\begin{figure*}[t]
    ...
    \vspace{-0.5cm}
		\subfloat{
			\includegraphics[width=0.7\textwidth]{f3d.pdf}
		}
	\end{center}
	\vspace{-0.7cm}
...
span a color range of $0<\bpmrpo<1.5$, due to the $V<14$ brightness
...
table).  For clarity, we have omitted the few upper
...
\begin{itemize}
  ...
  \item {\it The field star contamination rate increases at larger
    ...
    gyrochronological age near that of the Pleiades.  The false
    positive rate increases to $\approx$50\% at physical separations
    of $\approx$200\,pc.  Given the number density ratios of cluster
   ...
   \item {\it The rapid rotators show elevated lithium abundances, and
     ...
     stars to spin up on the pre-MS, producing less efficient internal
     mixing and a longer-lasting presence of photospheric lithium
