...
\begin{abstract}
  ...
  stars---false positives originating from overly aggressive clustering algorithms.
...
detected a rotation period, if the star were really a cluster member.
...
Qualitatively, the fraction of kinematic members with TESS-detection rotation 
periods with increasing distance from the halo core---both in
position and in velocity space.
To quantify this, we computed the distances.
