...
\begin{figure*}[t]
  ...
  \caption{ {\bf TESS rotations periods and dereddened Gaia colors for \cn.}
    ...
    \citep[650\,Myr;][]{douglas_poking_2017} are shown.
...
all of them, appear underneath the slow rotation sequence.  In set
...
binarity in the slow and fast rotation subsamples are 30\% (63/210)
