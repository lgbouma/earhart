...
$\exp(-\abs{d\sin(b)}/h)$ where $d$ is the average cluster distance,
...
\begin{figure}[h]
	...
	\end{center}
	\vspace{-0.7cm}
  \caption{ {\bf Fifty random-drawn \cn\ light curves sorted in order
  of stellar color.} Stars are from Set $\mathcal{A}$ (see Section
  {\bf TODO}.
