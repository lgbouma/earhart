...
\begin{figure*}[t]
	...
	\end{center}
	\vspace{-0.7cm}
  \caption{ {\bf NGC\,2516 has multiple reported components in position and
  ...
  assignment algorithms (see Appendix~\ref{app:clustering}).  The field
...
\begin{figure*}[t]
  ...
  \caption{ {\bf HR diagrams of NGC\,2516.}
    ...
    at intervals of $\log_{10}(t/\mathrm{yr})=\{8, 8.25, 8.5\}$ with a
...
at $\log_{10}(t/\mathrm{yr})=\{8, 8.25, 8.5\}$, and then applied the
reddening correction described in Section~\ref{subsec:tess}, in the
sense of adding the $E(Bp-Rp)$ correction to the synthetic Gaia EDR3
photometry.  The data and models generally agree for masses above
approximately 0.45\,$M_\odot$.  Below this mass, at colors redder than
Bp-Rp$\approx2.2$, the agreement is worse.  The MIST isochrones show a
...
the main-sequence turn-off (MSTO), since it is where the models have maximal
predictive power.
