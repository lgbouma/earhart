...
purity and accuracy of the Gaia-derived results are expected to be the
...
reported candidate members from \citet{meingast_2021}.}.  A useful
visualization of these samples is available online\footnote{
...
Gaia data, such an effort would be replicating the work of these
