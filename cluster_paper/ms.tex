...
ages as stars in the cluster's core, we use three different age-dating
...
constructed the filter using the Pleiades polynomial from
\citet{curtis_rup147_2020}, with hard cuts at the red and blue ends.}.
This yielded \nautorotnumeratormatching\ light curves\added{in Set
$\mathcal{B}$}. 
...
\added{The justification for the additional cut in Set $\mathcal{B}$ is
...
are most likely therefore either not cluster members, or they are cluster
...
assessing which are rotationally consistent with being in the cluster,
this is a viable filter; for the purpose of fully exploring whether any
rotational outliers could be bonafide cluster members, Set $\mathcal{A}$
...
\begin{figure*}[t!]
	\begin{center}
		\leavevmode
    \includegraphics[width=0.700\textwidth]{f5.pdf}
	\end{center}
	\vspace{-0.7cm}
...
the base sample are those for which we could have plausibly detected a
...
for \replaced{66\%}{68\%} of stars \replaced{at least 25\,pc from the
cluster core}{reported to be in the cluster}.  The average detection rate
inside of 25\,pc, \replaced{73\%}{72\%}, is slightly higher\added{ than
outside of 25\,pc, where the detection rate is 63\%}. Within
$\approx$3.5\,pc, the period detection rate of \replaced{61\%}{59\%} is
relatively low, due to crowding and saturation in the TESS images.
