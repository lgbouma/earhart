...
\newcommand{\nnbhdcaliblc}{10{,}314\ } % make_compstar_NGC_2516_sourcelist.py
\newcommand{\nnbhdcalibstar}{2{,}212\ } % make_compstar_NGC_2516_sourcelist.py
...
\begin{abstract}
  ...
  study, we focus on a 250\,pc halo reported
  around the $\approx$120\,Myr open cluster NGC\,2516.  The classical
  tidal radius of the cluster is {\bf $\sim$XX\,pc}.  Using photometry
  ...
  highlight the implications for spectroscopic survey targeting, open
