...
\begin{figure*}[t]
  ...
  the same number of stars in the denominator (54) per bin.  In the
...
comparison, we only show stars with $0.5<(Bp-Rp)_0<1.2$ for which our
...
Speaking in the positive though, our rotation period measurements show
