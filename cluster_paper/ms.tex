...
spectra as part of their \cn\ sample, and so we opted to use their
results rather than repeating their analysis.
...
the AstroPy-affiliated \texttt{specutils} package
\citep{specutils_v1pt1}.

%FIXME TODO: put it into words
% circa ~line 1224 from ~/Dropbox/proj/cdips_followup/cdips_followup/spectools.py
Our procedure was as follow...
