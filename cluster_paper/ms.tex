...
\title{
  ...
  An Open Cluster Spread Across 400\,pc
  %NGC\,2516  300\,pc
}
...
\begin{abstract}
  ...
  $\approx$400\,pc reported around the $\approx$150\,Myr open cluster
  NGC\,2516.
...
corresponds to total a length of $\approx$400\,pc, depending on which
...
Gaia-ESO \citep{randich_gaiaeso_2018} and GALAH DR3
\citep{buder_galah_2020}.  The target selection and results from each
...
target selection approach included some stars in the spatial proximity
of previously known members.  Since the existence of the \cn\ halo was
not known at the time of target selection, very few ``halo'' stars are in
the sample.  For \cn, \citet{randich_gaiaeso_2018} ultimately
...
members.  Cross-matching against our kinematic list of \nkinematic
candidate members by position and imposing a 0$\farcs$5 maximum
separation limit yields 492 kinematic members for which a Gaia-ESO
spectrum was acquired and stellar parameters were reported.  15 of
these (all with $(Bp-Rp)_0 > 2.0$) are spurious matches based on the
Gaia color and GES effective temperature, and we remove them.  This
yields 477 stars, of which 436 are in the core, and 41 are in the
halo.  The lop-sided ratio is primarily caused by the Gaia-ESO
selection function.
%FIXME VERIFY THAT THESE NUMBERS DON'T INCLUDE THEIR NANS...
