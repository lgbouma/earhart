...
\begin{figure*}[t!]
	\begin{center}
		\leavevmode
		\subfloat{
			\includegraphics[width=0.700\textwidth]{f5a.pdf}
		}

    \vspace{-0.5cm}
		\subfloat{
			\includegraphics[width=0.700\textwidth]{f5b.pdf}
		}
	\end{center}
	\vspace{-0.7cm}
...
\begin{figure*}[t]
  ...
  I07 and F20 analyzed stars in the core of \cn.
  \label{fig:litcomp}
	}
\end{figure*}
...
binaries, the cuts we used to select binaries (${\rm
RUWE}>1.2$; photometric excess $>$0.3\,mag) leave open a
...
The authors are grateful to G.~Zhou, B{.}~Tofflemire, A{.}~McWilliam,
E{.}~Newton, A{.}~Kraus, L{.}~Hillenbrand, and K{.}~Hawkins for the
discussions on young stars, rotation, and lithium that encouraged this
analysis.
%
