...
cp ../results/vtangential_projection/XYZ_with_orbit.pdf f2.pdf
...
cp ../results/rotation_X_positions/rotation_X_positions_approach2_defaultcleaning.pdf f6c.pdf

cp ../results/lithium/lithiumEW_vs_BpmRp_xmatch_fullfaintkinematic_gaiaeso_galahdr3_corehalosplit_showkepfield_showpleiades_showpraesepe.pdf f7.pdf

cp ../results/rotation_X_lithium/rotation_vs_BpmRp_X_lithium_viridis_gaiaeso_galahdr3.pdf f8.pdf

cp ../results/lumfunction_vs_position/lumfunction_vs_position.pdf f9.pdf

cp ../results/litcomp_ngc2516/litcomp_ngc2516.pdf f10.pdf
